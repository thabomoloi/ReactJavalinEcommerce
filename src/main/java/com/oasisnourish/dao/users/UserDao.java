package com.oasisnourish.dao.users;
...
/**
 * Data Access Object (DAO) interface for {@link User} entity. Extends the
 * generic {@link Dao} interface to provide additional methods specific to
 * {@link User} data access.
 */
